              ...
              <div className="w-full flex gap-5">
                <div className="w-72 flex flex-col gap-6 p-5 text-white">
                  ...
                  <div className="flex gap-10 mt-32 ml-1 ">
                    ...
                    <a
                      class="elementor-icon elementor-social-icon elementor-social-icon-instagram elementor-repeater-item-e162b7b"
                    ...
                    <a
                      class="elementor-icon elementor-social-icon elementor-social-icon-twitter elementor-repeater-item-d6a01f5"
                      target="_blank"
                    >
                      <svg
                        class="w-9"
